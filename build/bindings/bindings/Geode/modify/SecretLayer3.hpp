...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer3> : ModifyBase<ModifyDerive<Der, SecretLayer3>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SecretLayer3, revealStep2, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SecretLayer3, revealStep3, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SecretLayer3, revealStep4, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SecretLayer3, revealStep5, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SecretLayer3, showUnlockDialog, )
		}
	};
}
