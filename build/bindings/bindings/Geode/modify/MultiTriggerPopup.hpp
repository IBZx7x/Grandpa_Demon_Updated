...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MultiTriggerPopup> : ModifyBase<ModifyDerive<Der, MultiTriggerPopup>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MultiTriggerPopup, create, EffectGameObject*, cocos2d::CCArray*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(MultiTriggerPopup, init, EffectGameObject*, cocos2d::CCArray*)
		}
	};
}
