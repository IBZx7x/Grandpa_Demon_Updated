...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ObjectManager> : ModifyBase<ModifyDerive<Der, ObjectManager>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ObjectManager, loadCopiedSets, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ObjectManager, purgeObjectManager, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ObjectManager, replaceAllOccurencesOfString, cocos2d::CCString*, cocos2d::CCString*, cocos2d::CCDictionary*)
