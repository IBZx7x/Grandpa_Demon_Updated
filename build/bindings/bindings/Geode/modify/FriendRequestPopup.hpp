...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FriendRequestPopup> : ModifyBase<ModifyDerive<Der, FriendRequestPopup>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestPopup, blockUser, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x28e4b0, Thiscall, FriendRequestPopup, init, GJFriendRequest*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestPopup, loadFromGJFriendRequest, GJFriendRequest*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestPopup, onAccept, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestPopup, onBlock, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x28f440, Thiscall, FriendRequestPopup, onClose, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(FriendRequestPopup, onRemove, cocos2d::CCObject*)
		}
	};
}
