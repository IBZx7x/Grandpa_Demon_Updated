...
namespace geode::modifier {
	...
	#ifndef GEODE_CONCEPT_CHECK_endToLua
		#define GEODE_CONCEPT_CHECK_endToLua
		GEODE_CONCEPT_FUNCTION_CHECK(endToLua) 
	#endif
	...
	struct ModifyDerive<Der, cocos2d::CCRenderTexture> : ModifyBase<ModifyDerive<Der, cocos2d::CCRenderTexture>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::_ccColor4F const&>::func(&cocos2d::CCRenderTexture::setClearColor)), Thiscall, cocos2d::CCRenderTexture, setClearColor, cocos2d::_ccColor4F const&)
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??0CCRenderTexture@cocos2d@@QEAA@XZ")), Thiscall, cocos2d::CCRenderTexture, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??1CCRenderTexture@cocos2d@@UEAA@XZ")), Thiscall, cocos2d::CCRenderTexture)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCRenderTexture::endToLua)), Thiscall, cocos2d::CCRenderTexture, endToLua, )
