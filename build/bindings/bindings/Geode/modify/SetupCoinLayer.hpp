...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupCoinLayer> : ModifyBase<ModifyDerive<Der, SetupCoinLayer>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SetupCoinLayer, create, EffectGameObject*, cocos2d::CCArray*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SetupCoinLayer, init, EffectGameObject*, cocos2d::CCArray*)
		}
	};
}
