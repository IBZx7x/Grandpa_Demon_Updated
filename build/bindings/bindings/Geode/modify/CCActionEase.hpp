...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCActionEase> : ModifyBase<ModifyDerive<Der, cocos2d::CCActionEase>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??1CCActionEase@cocos2d@@UEAA@XZ")), Thiscall, cocos2d::CCActionEase)
