...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::extension::CCControl> : ModifyBase<ModifyDerive<Der, cocos2d::extension::CCControl>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??0CCControl@extension@cocos2d@@QEAA@XZ")), Thiscall, cocos2d::extension::CCControl, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??1CCControl@extension@cocos2d@@UEAA@XZ")), Thiscall, cocos2d::extension::CCControl)
