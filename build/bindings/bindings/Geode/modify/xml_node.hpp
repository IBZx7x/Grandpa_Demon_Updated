...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, pugi::xml_node> : ModifyBase<ModifyDerive<Der, pugi::xml_node>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??0xml_node@pugi@@QEAA@XZ")), Thiscall, pugi::xml_node, )
		}
	};
}
