...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, PlayerObject> : ModifyBase<ModifyDerive<Der, PlayerObject>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PlayerObject, didHitHead, )
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PlayerObject, flashPlayer, float, float, cocos2d::ccColor3B, cocos2d::ccColor3B)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PlayerObject, getActiveMode, )
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PlayerObject, playerIsFallingBugged, )
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PlayerObject, runRotateAction, bool, int)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PlayerObject, stopRotation, bool, int)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PlayerObject, updateCheckpointMode, bool)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PlayerObject, updatePlayerSpriteExtra, gd::string)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PlayerObject, updateShipSpriteExtra, gd::string)
