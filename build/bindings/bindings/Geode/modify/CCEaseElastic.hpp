...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCEaseElastic> : ModifyBase<ModifyDerive<Der, cocos2d::CCEaseElastic>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<CCActionInterval*, float>::func(&cocos2d::CCEaseElastic::initWithAction)), Thiscall, cocos2d::CCEaseElastic, initWithAction, CCActionInterval*, float)
