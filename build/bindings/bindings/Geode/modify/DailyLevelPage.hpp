...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, DailyLevelPage> : ModifyBase<ModifyDerive<Der, DailyLevelPage>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(DailyLevelPage, createNodeIfLoaded, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(DailyLevelPage, downloadAndCreateNode, )
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(DailyLevelPage, skipDailyLevel, DailyLevelNode*, GJGameLevel*)
