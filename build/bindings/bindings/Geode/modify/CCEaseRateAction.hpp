...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCEaseRateAction> : ModifyBase<ModifyDerive<Der, cocos2d::CCEaseRateAction>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??1CCEaseRateAction@cocos2d@@UEAA@XZ")), Thiscall, cocos2d::CCEaseRateAction)
