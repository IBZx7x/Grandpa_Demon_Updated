...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJShaderState> : ModifyBase<ModifyDerive<Der, GJShaderState>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJShaderState, reset, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJShaderState, stopTweenAction, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJShaderState, timesyncShaderAction, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJShaderState, timesyncShaderActions, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJShaderState, tweenValue, float, float, int, float, int, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJShaderState, updateTweenAction, float, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJShaderState, updateTweenActions, float)
		}
	};
}
