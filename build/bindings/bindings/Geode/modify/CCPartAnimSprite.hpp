...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCPartAnimSprite> : ModifyBase<ModifyDerive<Der, CCPartAnimSprite>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, createWithAnimDesc, char const*, cocos2d::CCTexture2D*, bool)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, initWithAnimDesc, char const*, cocos2d::CCTexture2D*, bool)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCPartAnimSprite, tweenToFrame, cocos2d::CCSpriteFrame*, float)
		}
	};
}
