...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJEffectManager> : ModifyBase<ModifyDerive<Der, GJEffectManager>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJEffectManager, createMoveCommand, cocos2d::CCPoint, int, float, int, float, bool, bool, bool, bool, float, float, int, int)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJEffectManager, startTimer, int, double, double, bool, bool, bool, float, bool, int, gd::vector<int> const&, int, int)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJEffectManager, tryGetMoveCommandNode, int)
