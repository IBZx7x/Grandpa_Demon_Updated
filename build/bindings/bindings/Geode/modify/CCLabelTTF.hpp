...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLabelTTF> : ModifyBase<ModifyDerive<Der, cocos2d::CCLabelTTF>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??0CCLabelTTF@cocos2d@@QEAA@XZ")), Thiscall, cocos2d::CCLabelTTF, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??1CCLabelTTF@cocos2d@@UEAA@XZ")), Thiscall, cocos2d::CCLabelTTF)
