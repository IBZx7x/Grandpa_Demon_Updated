...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTexture2D> : ModifyBase<ModifyDerive<Der, cocos2d::CCTexture2D>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<char const*, cocos2d::_ccFontDefinition*>::func(&cocos2d::CCTexture2D::initWithString)), Thiscall, cocos2d::CCTexture2D, initWithString, char const*, cocos2d::_ccFontDefinition*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::_ccTexParams*>::func(&cocos2d::CCTexture2D::setTexParameters)), Thiscall, cocos2d::CCTexture2D, setTexParameters, cocos2d::_ccTexParams*)
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??1CCTexture2D@cocos2d@@UEAA@XZ")), Thiscall, cocos2d::CCTexture2D)
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??0CCTexture2D@cocos2d@@QEAA@XZ")), Thiscall, cocos2d::CCTexture2D, )
