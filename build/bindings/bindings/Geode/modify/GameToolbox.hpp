...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameToolbox> : ModifyBase<ModifyDerive<Der, GameToolbox>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameToolbox, easeToText, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameToolbox, fast_rand, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameToolbox, fast_rand_0_1, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameToolbox, fast_rand_minus1_1, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameToolbox, fast_srand, uint64_t)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameToolbox, getfast_srand, )
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameToolbox, msToTimeString, int, int)
