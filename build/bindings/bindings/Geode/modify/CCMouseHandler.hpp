...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCMouseHandler> : ModifyBase<ModifyDerive<Der, cocos2d::CCMouseHandler>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??1CCMouseHandler@cocos2d@@UEAA@XZ")), Thiscall, cocos2d::CCMouseHandler)
