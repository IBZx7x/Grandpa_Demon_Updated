...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCSkewTo> : ModifyBase<ModifyDerive<Der, cocos2d::CCSkewTo>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??0CCSkewTo@cocos2d@@QEAA@XZ")), Thiscall, cocos2d::CCSkewTo, )
