...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SongSelectNode> : ModifyBase<ModifyDerive<Der, SongSelectNode>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc5f80, Default, SongSelectNode, create, int, bool, LevelSettingsObject*, SongSelectType, cocos2d::CCPoint, cocos2d::CCNode*, cocos2d::CCMenu*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc6fe0, Thiscall, SongSelectNode, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc7070, Thiscall, SongSelectNode, customSongLayerClosed, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc70a0, Thiscall, SongSelectNode, songIDChanged, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc70b0, Thiscall, SongSelectNode, getActiveSongID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc70c0, Thiscall, SongSelectNode, getSongFileName, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc7180, Thiscall, SongSelectNode, getLevelSettings, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc6ab0, Thiscall, SongSelectNode, audioNext, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc6af0, Thiscall, SongSelectNode, audioPrevious, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc60b0, Thiscall, SongSelectNode, init, int, bool, LevelSettingsObject*, SongSelectType, cocos2d::CCPoint, cocos2d::CCNode*, cocos2d::CCMenu*, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SongSelectNode, onOpenCustomSong, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SongSelectNode, onSongMode, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc6b50, Thiscall, SongSelectNode, onSongMode, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(SongSelectNode, selectSong, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc6e80, Thiscall, SongSelectNode, showCustomSongSelect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc69c0, Thiscall, SongSelectNode, updateAudioLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc6d70, Thiscall, SongSelectNode, updateWidgetVisibility, )
		}
	};
}
