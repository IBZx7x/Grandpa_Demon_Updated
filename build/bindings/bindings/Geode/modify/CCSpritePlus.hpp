...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCSpritePlus> : ModifyBase<ModifyDerive<Der, CCSpritePlus>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(base::get() + 0x456a0, Thiscall, CCSpritePlus, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCSpritePlus, createWithSpriteFrame, cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x47d10, Default, CCSpritePlus, createWithSpriteFrameName, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x481d0, Thiscall, CCSpritePlus, setScaleX, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48250, Thiscall, CCSpritePlus, setScaleY, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x482e0, Thiscall, CCSpritePlus, setScale, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x47dd0, Thiscall, CCSpritePlus, setPosition, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x47e60, Thiscall, CCSpritePlus, setRotation, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x47ef0, Thiscall, CCSpritePlus, setRotationX, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x47f80, Thiscall, CCSpritePlus, setRotationY, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x47db0, Thiscall, CCSpritePlus, initWithTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x47da0, Thiscall, CCSpritePlus, initWithSpriteFrameName, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48010, Thiscall, CCSpritePlus, setFlipX, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x480f0, Thiscall, CCSpritePlus, setFlipY, bool)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCSpritePlus, getFollower, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48370, Thiscall, CCSpritePlus, removeFollower, cocos2d::CCNode*)
