...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupTouchTogglePopup> : ModifyBase<ModifyDerive<Der, SetupTouchTogglePopup>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(SetupTouchTogglePopup, create, EffectGameObject*, cocos2d::CCArray*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x44c4b0, Thiscall, SetupTouchTogglePopup, onDualTouchMode, cocos2d::CCObject*)
