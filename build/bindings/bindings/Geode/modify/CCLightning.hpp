...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCLightning> : ModifyBase<ModifyDerive<Der, cocos2d::CCLightning>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x444d0, Thiscall, cocos2d::CCLightning)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x44950, Thiscall, cocos2d::CCLightning, setColor, cocos2d::_ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x449c0, Thiscall, cocos2d::CCLightning, updateDisplayedColor, cocos2d::_ccColor3B const&)
