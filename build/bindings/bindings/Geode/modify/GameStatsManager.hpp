...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameStatsManager> : ModifyBase<ModifyDerive<Der, GameStatsManager>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameStatsManager, areRewardsLoaded, )
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameStatsManager, countSecretChests, GJRewardType)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameStatsManager, countUnlockedSecretChests, GJRewardType)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameStatsManager, postLoadGameStats, )
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameStatsManager, storeQueuedChallenge, int, GJChallengeItem*)
