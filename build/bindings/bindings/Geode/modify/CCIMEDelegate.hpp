...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCIMEDelegate> : ModifyBase<ModifyDerive<Der, cocos2d::CCIMEDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??0CCIMEDelegate@cocos2d@@QEAA@XZ")), Thiscall, cocos2d::CCIMEDelegate, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??1CCIMEDelegate@cocos2d@@UEAA@XZ")), Thiscall, cocos2d::CCIMEDelegate)
