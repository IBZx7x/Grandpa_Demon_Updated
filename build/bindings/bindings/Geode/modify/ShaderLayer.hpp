...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ShaderLayer> : ModifyBase<ModifyDerive<Der, ShaderLayer>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4697b0, Thiscall, ShaderLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46a560, Thiscall, ShaderLayer, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x470580, Thiscall, ShaderLayer, visit, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, objectPosToShaderPos, cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46fbd0, Thiscall, ShaderLayer, performCalculations, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, preBulgeShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, preChromaticGlitchShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, preChromaticShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, preColorChangeShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, preCommonShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, preGlitchShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, preGrayscaleShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, preHueShiftShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, preInvertColorShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, preLensCircleShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, preMotionBlurShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, prepareTargetContainer, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, prePinchShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, prePixelateShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, preRadialBlurShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, preSepiaShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, preShockLineShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, preShockWaveShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, preSplitScreenShader, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4710f0, Thiscall, ShaderLayer, resetAllShaders, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, resetTargetContainer, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, setupBulgeShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, setupChromaticGlitchUniforms, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, setupChromaticUniforms, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, setupColorChangeShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, setupCommonUniforms, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, setupGlitchUniforms, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, setupGrayscaleShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, setupHueShiftShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, setupInvertColorShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, setupLensCircleShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, setupMotionBlurShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, setupPinchShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, setupRadialBlurShader, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, setupSepiaShader, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4698c0, Thiscall, ShaderLayer, setupShader, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, setupShockLineUniforms, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, setupShockWaveUniforms, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, setupSplitScreenShader, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46a4f0, Thiscall, ShaderLayer, toggleAntiAlias, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerBulge, float, float, float, float, float, int, int, float, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerChromaticGlitch, bool, float, float, float, float, float, float, float, int, float, bool, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerChromaticX, float, float, int, float, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerChromaticY, float, float, int, float, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerColorChange, float, float, float, float, float, float, float, int, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerGlitch, float, float, float, float, float, float, float, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerGrayscale, float, float, bool, int, int, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerHueShift, float, float, int, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerInvertColor, float, float, float, float, float, bool, bool, bool, int, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerLensCircle, float, float, float, float, int, int, float, float, int, float, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerMotionBlurX, float, float, float, float, int, float, bool, int, int, float, bool, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerMotionBlurY, float, float, float, float, int, float, bool, int, int, float, bool, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerPinchX, float, float, float, float, float, bool, int, int, float, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerPinchY, float, float, float, float, float, bool, int, int, float, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerPixelateX, float, float, bool, bool, int, float, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerPixelateY, float, float, bool, bool, int, float, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerRadialBlur, float, float, float, float, int, float, float, bool, int, int, float, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerSepia, float, float, int, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerShockLine, float, float, bool, bool, bool, bool, float, float, float, float, float, float, int, bool, bool, bool, float, bool, float, int, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerShockWave, float, float, float, float, float, float, float, bool, float, float, float, int, bool, bool, bool, float, float, bool, float, int, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerSplitScreenCols, float, float, int, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, triggerSplitScreenRows, float, float, int, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, tweenValue, float, float, int, float, int, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, tweenValueAuto, float, int, float, int, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, updateEffectOffsets, cocos2d::CCPoint)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, updateMotionBlurSpeedX, float, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, updateMotionBlurSpeedY, float, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, updateShockLineCenter, cocos2d::CCPoint)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, updateShockWaveCenter, cocos2d::CCPoint)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(ShaderLayer, updateZLayer, int, int, bool)
		}
	};
}
