...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameLevelManager> : ModifyBase<ModifyDerive<Der, GameLevelManager>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameLevelManager, getActiveDailyID, GJTimedLevelType)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameLevelManager, getDailyID, GJTimedLevelType)
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameLevelManager, uploadComment, gd::string, CommentType, int, int)
