...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCCallFuncN> : ModifyBase<ModifyDerive<Der, cocos2d::CCCallFuncN>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<cocos2d::CCObject*, cocos2d::SEL_CallFuncN>::func(&cocos2d::CCCallFuncN::initWithTarget)), Thiscall, cocos2d::CCCallFuncN, initWithTarget, cocos2d::CCObject*, cocos2d::SEL_CallFuncN)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<CCZone*>::func(&cocos2d::CCCallFuncN::copyWithZone)), Thiscall, cocos2d::CCCallFuncN, copyWithZone, CCZone*)
